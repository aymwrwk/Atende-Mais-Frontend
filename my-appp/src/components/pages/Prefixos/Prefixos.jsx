...
const GerenciarPrefixos = () => {
  ...
  const fetchPrefixos = async () => {
    try {
      ...
      const response = await axios.get(`${API_BASE_URL}/prefixos/buscar-prefixo`,
        {
          headers: {
  ...
  const adicionarPrefixo = async () => {
    ...
    try {
      ...
      await axios.post(
        `${API_BASE_URL}/prefixos/adicionar-prefixo`,
        { prefixo: novoPrefixo },
        {
          headers: {
            'Authorization': `Bearer ${token}`,
  ...
  const excluirPrefixo = async (prefixo) => {
    try {
      await axios.delete( `${API_BASE_URL}/prefixos/excluir-prefixo`, {
        data: { prefixo },
        headers: {
